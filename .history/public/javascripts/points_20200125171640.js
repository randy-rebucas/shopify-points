...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        const pointEl = '<div id="point-wrapper"><form><textarea name="input"></textarea><input type="submit" value="submit" id="submit"/></form><h5>Your Tasty Point</h5><p id="point-count">2000</p></div>';
        $('body').append(pointEl);
        const inputVal = {
            "scrdata_id" : 60,
        ...
        const obj = JSON.stringify(inputVal);
        $('div#point-wrapper').find('textarea').text(obj);
        ...
        function addPoints(srcId, tpSessionId, accessToken) {
            ...
            ajaxRequest(urlTarget, postData, function(response) {
                ...
                $('div#point-wrapper #point-count').text(resObj.total_tp_points);
            });
        }
        /**
         * @param {*} srcId number
