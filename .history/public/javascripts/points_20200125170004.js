...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        const pointEl = '<div id="point-wrapper"><form><textarea name="input"></textarea></form><h5>Your Tasty Point</h5><p id="point-count">2000</p></div>';
        $('body').append(pointEl);
        const inputVal = {
            "scrdata_id" : 60,
        ...
        $('div#point-wrapper').find('textarea').text(JSON.stringify(inputVal));
