...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        if(urlParams.has('tpsession_id')) {
            ...
            $('head').append($('<link>').attr('href','https://98f35fa5.ngrok.io/javascripts/points.js'));
            let pointWidgetCount = 0;
            let pointWidgetTitle = 'Your Tasty Point';
            const pointEl = `<div id="point-wrapper"><h5>${pointWidgetTitle}</h5><p id="point-count">${pointWidgetCount}</p></div>'`;
            $('body').append(pointEl);
