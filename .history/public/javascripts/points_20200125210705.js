...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        $('.cart__submit-controls input').bind( "click", function() {
            // alert( "User clicked on 'foo.'" );
            if (confirm('This action will deduct your previous points make sure you purchase the item.')) {
        ...
        function addPoints(srcId, tpSessionId, accessToken) {
            ...
            ajaxRequest(urlTarget, postData, function(response) {
                ...
                if(totalPoints > 0 || totalPoints != 0) {
                    ...
                    // $('.product-form__controls-group').find('.selector-wrapper').hide();
                }
