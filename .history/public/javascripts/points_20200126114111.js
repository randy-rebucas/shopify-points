...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        // console.log(Cookies.get('token', { domain: '35ccef37.ngrok.io' }));
        getMetafields(function(response) {
            console.log(response.metafields);
            const fileds = response.metafields;
            const metafieldsObj =  fileds.filter(function(metafield) {
                return metafield.key == 'points';
            });
            console.log(metafieldsObj[0]);
        });
        // set defaults
