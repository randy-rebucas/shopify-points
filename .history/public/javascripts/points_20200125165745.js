...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        const pointEl = `<div id="point-wrapper"><form><textarea name="input" value="${JSON.stringify(inputVal)}"</textarea></form><h5>Your Tasty Point</h5><p id="point-count">2000</p></div>`;
        $('body').append(pointEl);
