...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        loadScript('//raw.githubusercontent.com/js-cookie/js-cookie/v1.5.1/src/js.cookie.js', function(){
            function getTpSessionId() {
                return $.cookie('tpSessionId');
                // return Cookies.get('tpSessionId')
            }
    
            function setTpSessionId(tpSessionId) {
                // Cookies.set('tpSessionId', tpSessionId)
                $.cookie('tpSessionId', tpSessionId);
            }
        });
        // get the url params
