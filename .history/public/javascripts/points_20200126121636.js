...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        function getWidgetShape() { return this.isRounded; }
        function setWidgetShape(shape) { isRounded = shape; }
        ...
        getMetafields(function(response) {
            ...
            setWidgetShape(metafieldVal.isRounded);
        });
        setTimeout(function(){ 
            $('div#point-wrapper h5').text(getWidgetTitle());
        }, 1000);
