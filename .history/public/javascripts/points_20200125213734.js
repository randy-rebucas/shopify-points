...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        $(document).on('click', '.hasPoints', function() {
            if (confirm('This action will deduct your current points make sure you purchase the item.')) {
                const item_name = $('.list-view-item__title').find('a').text();
                console.log('Item name:' + item_name);
                const item_price = $('.cart__price').find('dd').text();
                console.log('Item price:' + item_price);
                // const user_paid_amount // deducted points
                const quantity = $('.cart__quantity-td .cart__qty').find('input').val();
                console.log('qty:' + quantity)
                // const item_category_name
                const points_used = $('.product-details li:last-child() span').last().text();
                console.log('points used:' + points_used)
                const item_page_link = $('.list-view-item__title').find('a').attr('href');
                console.log('link:' + item_page_link);
                return false;
                // const srcId = 61;
                // const tpSessionId = '60655f85-7927-4d3a-ba36-e5582a39280f'
                // const accessToken = 'Aef5f85-79ef27qwwd-4d3a-ba36-e5582a3dw'
                // const usedPoints = 175
                // const selectedItems = {
                //     "item_name" : "",
                //     "item_price" : "",
                //     "user_paid_amount" : "",
