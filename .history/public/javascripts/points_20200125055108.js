...
(function(){
    ...
    var myAppJavaScript = function($){
        ...
        if(urlParams.has('tpsession_id')) {
            ...
            //     url: 'https://98f35fa5.ngrok.io/points', // 'https://tastypoints.io/akm/restapi.php',
            //     data: postData,
            ...
            xhr.open("POST", 'https://tastypoints.io/akm/restapi.php', true);

            //Send the proper header information along with the request
            xhr.setRequestHeader("Content-Type", "application/json");
            xhr.setRequestHeader("Access-Control-Allow-Origin", "https://branchleaves-one.myshopify.com");
