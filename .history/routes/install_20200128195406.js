...
const forwardingAddress = 'https://e8946d2a.ngrok.io'; // process.env.SHOPIFY_APP_HOST; // Replace this with your HTTPS Forwarding address
/* GET users listing. */
router.get('/', (req, res) => {
                        ...
                        request.post(scriptTagRequestUrl, {
                            ...
                            .then((scripTagResponse) => {
                                ...
                                const jsonObj = JSON.stringify({
                                    ...
                                    pointWidgetPosition: 'The Tasty Points',
