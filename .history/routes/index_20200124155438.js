...
const forwardingAddress = 'https://28e653d0.ngrok.io'; // Replace this with your HTTPS Forwarding address
/* GET users listing. */
router.get('/', (req, res) => {
    const shop = req.query.shop;
    if (shop) {
        const tokenCookie = cookie.parse(req.headers.cookie).state;
